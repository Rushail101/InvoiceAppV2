...
// ─── CHALLAN MODAL ─────────────────────────────────────────────────────────────
function ChallanModal({ onClose, onSave, businesses, parties, allChallans, invoices, editData, activeBizId }) {
...
export function DeliveryChallansView({ challans, parties, businesses, invoices, activeBiz, reload }) {
  ...
  // activeBiz is a string ID (same pattern as all other views)
  const bizChallans = activeBiz
    ? challans.filter(c => c.business_id === activeBiz)
    : challans;
