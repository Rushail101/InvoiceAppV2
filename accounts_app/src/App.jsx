...
import { BankImportView } from './views/BankImport.jsx';
...
const NAV = [
  ...
  { id: 'bankimport',  label: 'Import Statement',  icon: '⬆',   group: 'Purchases' },
      ...
      <div className="app">
        ...
        <div className="main">
          ...
          <div className="content">
            ...
            {!loading && view === 'bankimport' && (
              <BankImportView bankAccounts={bankAccounts} bankTransactions={bankTransactions} businesses={businesses} activeBiz={activeBiz} reload={reload} />
            )}
